  ...
  return (
    <div className="flex gap-6 w-full justify-center mt-6 mb-8">
      ...
      <ClassificationStatCard
        ...
        icon={<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M21.4 12.8367C21.3999 14.7373 20.7982 16.589 19.681 18.1266C18.5638 19.6642 16.9885 20.8086 15.1809 21.3958C13.3733 21.9831 11.4262 21.983 9.61867 21.3957C7.81111 20.8083 6.2359 19.6638 5.11879 18.1262C4.00168 16.5886 3.40001 14.7368 3.40002 12.8362C3.40004 10.9356 4.00173 9.08378 5.11887 7.54617C6.236 6.00856 7.81123 4.86408 9.61879 4.27675C11.4264 3.68941 13.3734 3.68939 15.181 4.27667" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            } // Replace with your image/icon
      />
      <ClassificationStatCard
        ...
        icon={<span className="w-7 h-7  rounded">
            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3.40002 12.8367C3.40002 10.4497 4.34824 8.16054 6.03606 6.47271C7.72389 4.78488 10.0131 3.83667 12.4 3.83667C14.9161 3.84614 17.3311 4.82789 19.14 6.57667L21.4 8.83667" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M21.4 3.83667V8.83667H16.4" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M21.4 12.8367C21.4 15.2236 20.4518 17.5128 18.764 19.2006C17.0762 20.8885 14.787 21.8367 12.4 21.8367C9.88398 21.8272 7.46899 20.8454 5.66002 19.0967L3.40002 16.8367" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8.40002 16.8367H3.40002V21.8367" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

        </span> } // Replace with your image/icon
      />
      <ClassificationStatCard
        value={245}
        ...
        icon={<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19.3999 21.8367L12.3999 17.8367L5.3999 21.8367V5.83667C5.3999 5.30624 5.61062 4.79753 5.98569 4.42246C6.36076 4.04738 6.86947 3.83667 7.3999 3.83667H17.3999C17.9303 3.83667 18.439 4.04738 18.8141 4.42246C19.1892 4.79753 19.3999 5.30624 19.3999 5.83667V21.8367Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M15.3999 10.8367H9.3999" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            } // Replace with your image/icon
      />
    </div>
