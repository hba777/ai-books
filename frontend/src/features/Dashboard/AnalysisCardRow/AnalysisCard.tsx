...
const AnalysisCard: React.FC<AnalysisCardProps> = ({ value, label, icon }) => {
  return (
    <div className="flex items-center justify-between bg-white rounded-xl shadow p-4 sm:p-6 lg:p-8 w-full min-w-[280px] sm:min-w-[400px] lg:min-w-[500px] max-w-[550px] h-32 sm:h-36 lg:h-38">
